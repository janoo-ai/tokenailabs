  ...
  return (
    <>
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(51 ,65 ,85,1 ) 2%, #010b13 92%)",
        }}>
        <div className="w-full h-fit bg-trans-black pt-16 md:pt-20 lg:pt-16">
          <div className="flex-grow w-full   flex flex-col md:flex-row p-3 md:p-5 lg:p-10">
            ...
            <div className=" gap-3 poppins-regular w-full md:w-1/2  bg-trans-black p-3 md:p-5 lg:p-10 flex flex-col justify-center">
              <div className="font-semibold text-cyan-400 relative before:content-[''] before:w-16 before:absolute before:top-1/2  before:left-0 before:transform before:-trancyan-y-1/2 before:h-1 before:bg-gradient-to-r before:from-fuchsia-600 before:to-pink-600 pl-20 ">
                About Us
              </div>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, #002147 2%, rgba(2 ,6, 23,1) 80%)",
        }}>
        <div className=" bg-trans-black  w-full h-full ">
          <div className="w-full gap-3 rounded-xl h-full bg-trans-black p-3 sm:p-5 md:p-10 flex flex-col justify-center items-center gap-2">
            <div className="mt-10 text-sm md:text-base font-semibold text-cyan-400 relative before:content-[''] before:w-16 before:absolute before:top-1/2  before:left-0 before:transform before:-trancyan-y-1/2 before:h-1 before:bg-gradient-to-r before:from-fuchsia-600 before:to-pink-600 pl-20 ">
              How It Works
            </div>
            <div className=" text-2xl md:text-4xl text-cyan-300 font-bold text-center">
            ...
            <div className="w-full h-full grid grid-cols-1 md:grid-cols-3 mt-3 gap-5 mb-10">
              <div className="w-full h-full bg-gradient-to-r from-stone-800 to-stone-950 flex-col flex px-6 py-8 rounded-xl justify-evenly group transition-all duration-300">
                ...
                <div>
                  <div className="text-xl  text-cyan-300 font-semibold mt-2 group-hover:bg-gradient-to-r group-hover:from-fuchsia-400 group-hover:to-pink-500 transition-all duration-300 group-hover:bg-clip-text group-hover:text-transparent ">
      ...
      <div className="w-full h-fit  p-0 ">
        <div className="w-full h-fit  p-0 bg-gradient-to-b from-slate-900 via-[#00217f] to-[#070122] ">
                ...
                <div className="w-full p-3 sm:p-5 md:px-10 h-full flex flex-col md:flex-row justify-center items-center bg-white rounded ">
                  <div className="w-full h-[60vh] relative ">
                    <div
                      ...
                      <p
                        id="introduction"
                        className="poppins-regular text-base ">
                        ...
                        Intelligence (AI) to create intelligent chatbot
                        solutions that redefine customer interaction. Our
                        commitment to innovation, quality, and customer
                        satisfaction has positioned us as leaders in the AI
                        chatbot services industry.
                        <br />
                        <br />
                        Founded in 2024, Token AI Labs pvt. ltd. was born out of
                        a desire to improve how businesses connect with their
                        customers. We recognized the growing demand for instant,
                        efficient communication solutions and set out to develop
                        cutting-edge AI technologies that would not only meet
                        but exceed those expectations. Today, we are proud to be
                        a trusted partner for companies seeking to enhance their
                        customer engagement strategies through intelligent
                        chatbot solutions
                      </p>
                      <br />
                      <br />
                      <p id="ourmission" className="poppins-regular text-base ">
                        ...
                        simplifies and enhances customer interactions. We
                        believe that effective communication is the cornerstone
                        of successful relationships, and our chatbots are
                        designed to facilitate this in a seamless and efficient
                        manner. Our goal is to provide businesses with tools
                        that enable them to deliver exceptional customer
                        ...
                        industry trends, incorporating the latest advancements
                        in AI and machine learning to deliver state-of-the-art
                      ...
                      <p
                        ...
                        digital landscape. By democratizing access to
                        intelligent chatbot technology, we aim to empower
                        businesses to connect with their customers in meaningful
                        ways, fostering loyalty and satisfaction.
                      </p>
                      <p
                        id="ourservices"
                        className="poppins-regular text-base mb-40 ">
                        ...
                        <br />
                        <br />
                        At Token AI Labs pvt. ltd, we offer a comprehensive
                        suite of AI-driven chatbot services tailored to meet the
                        unique needs of our clients. Our offerings include:
                        <br />
                        <br />
                        <strong>Customer Service Automation:</strong> Our
                        chatbots are equipped to handle a wide range of customer
                        inquiries, providing instant support and reducing wait
                        times. By automating routine tasks, businesses can free
                        ...
                        level of customization not only enhances user
                        satisfaction but also fosters deeper connections between
                      ...
                      <p
                        ...
                        <br />
                        <br />
                        Our team members are not only skilled in their
                        respective fields but also deeply understand the needs
                        of businesses and consumers. This combination of
                        expertise and empathy enables us to create chatbot
