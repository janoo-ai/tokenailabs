...
function Contact1() {
  return (
    <div className="w-full p-2 md:p-10 bg-black text-slate-400">
      <div className="flex flex-col p-2 md:p-10 bg-[rgba(255,255,255,0.1)] rounded-xl gap-1">
        ...
        <div className="w-full grid grid-cols-12 gap-4 mt-5">
          <div className="col-span-12 md:col-span-4 flex p-5 rounded-xl bg-black text-slate-50 flex-col gap-2 hover:invert">
          ...
          <div className="col-span-12 md:col-span-4  flex  p-5 rounded-xl bg-black flex-col text-slate-50 gap-1 hover:invert">
